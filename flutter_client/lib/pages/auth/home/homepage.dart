...
import 'package:flutter_client/pages/auth/home/upload_page.dart';
import 'package:flutter_client/pages/auth/home/video_player_page.dart';
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final thumbnail =
                  "https://d33j9oov689qac.cloudfront.net/${video['video_s3_key'].replaceAll('.mp4', ".jpg").replaceAll("videos/", "thumbnails/")}";
